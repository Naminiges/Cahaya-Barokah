<div class="d-flex flex-column flex-shrink-0 p-3 text-white" style="width: 280px; height: 100vh; background-color: #6756ff">
    <style>
    ...
    <a href="/" class="d-flex align-items-center mb-3 mb-md-0 me-md-auto text-white text-decoration-none">
        ...
        <h4 style="text-align: center; margin-left: -10px; margin-top: 15px">Toko Cahaya Barokah</h4>
    </a>
    <br>
